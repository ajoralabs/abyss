		...
		<section ref={container} className="py-32 relative overflow-hidden">
			...
			<div className="absolute inset-0 opacity-10 pointer-events-none">
				...
				>
					...
					/>
					<path
						d="M0 30 Q 25 60, 50 30 T 100 30"
						stroke="white"
						strokeWidth="0.2"
						fill="none"
					/>
			...
			<div className="container mx-auto px-6 relative z-10">
				<div className="text-center mb-24">
					...
					<p className="text-xl text-gray-400 max-w-2xl mx-auto">
						Abyss CLI is available everywhere today. Native desktop performance
						is coming next.
					</p>
				</div>
				...
				<div className="relative">
					...
					<div className="absolute top-1/2 left-0 w-full h-1 bg-linear-to-r from-blue-500 via-green-500 to-purple-500 -translate-y-1/2 hidden md:block rounded-full origin-left roadmap-line-progress" />

					<div className="grid grid-cols-1 md:grid-cols-3 gap-12">
						{milestones.map((item) => (
							<div key={item.title} className="roadmap-item relative group">
