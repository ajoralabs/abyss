...
VoidFlux is a modern, privacy-focused API client that runs in your terminal and renders a beautiful GUI in your browser. All your data stays local.

## Features
- **Local-First**: Your data never leaves your machine.
- **CLI & GUI**: Use the terminal for speed, or the GUI for complex workflows.
- **No Login Required**: Just run `voidflux dev` and start testing.
...
```bash
# Clone the repo
git clone https://github.com/voidflux/voidflux.git
cd voidflux
...
- **apps/web**: The marketing website (voidflux.com).
